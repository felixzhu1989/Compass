...
--UVI555400
if exists (select * from sysobjects where name='UVI555400')
drop table UVI555400
go
create table UVI555400
(
    UVI555400Id int identity(1,1),
    ModuleTreeId int,
    Length decimal(6,2),
    Deepth decimal(6,2),
	Height varchar(10),
...
--HWUVI650，华为1.2mm板材
if exists (select * from sysobjects where name='HWUVI650')
drop table HWUVI650
go
create table HWUVI650
(
    HWUVI650Id int identity(1,1),
    ModuleTreeId int,
    Length decimal(6,2),
    Deepth decimal(6,2),
	Height varchar(10),
...
--KVX555TP
if exists (select * from sysobjects where name='KVX555TP')
drop table KVX555TP
go
create table KVX555TP
(
    KVX555TPId int identity(1,1),
    ModuleTreeId int,
    Length decimal(6,2),
    Deepth decimal(6,2),
	Height varchar(10),
...
--法国烟罩FRUVF555
if exists (select * from sysobjects where name='FRUVF555')
drop table FRUVF555
go
create table FRUVF555
(
    FRUVF555Id int identity(1,1),
    ModuleTreeId int,
    Length decimal(6,2),
    Deepth decimal(6,2),
	Height varchar(10),
...
--HWUVF650，华为1.2mm板材
if exists (select * from sysobjects where name='HWUVF650')
drop table HWUVF650
go
create table HWUVF650
(
    HWUVF650Id int identity(1,1),
    ModuleTreeId int,
    Length decimal(6,2),
    Deepth decimal(6,2),
	Height varchar(10),
...
if exists (select * from sysobjects where name='HWUVF555400')
drop table HWUVF555400
go
create table HWUVF555400
(
    HWUVF555400Id int identity(1,1),
    ModuleTreeId int,
    Length decimal(6,2),
    Deepth decimal(6,2),
	Height varchar(10),
...
--法国烟罩FRKVF555
if exists (select * from sysobjects where name='FRKVF555')
drop table FRKVF555
go
create table FRKVF555
(
    FRKVF555Id int identity(1,1),
    ModuleTreeId int,
    Length decimal(6,2),
    Deepth decimal(6,2),
	Height varchar(10),
...
--HWUWF650，华为1.2mm板材
if exists (select * from sysobjects where name='HWUWF650')
drop table HWUWF650
go
create table HWUWF650
(
    HWUWF650Id int identity(1,1),
    ModuleTreeId int,
    Length decimal(6,2),
    Deepth decimal(6,2),
	Height varchar(10),
...
--HWUWF555，华为1.2mm板材
if exists (select * from sysobjects where name='HWUWF555')
drop table HWUWF555
go
create table HWUWF555
(
    HWUWF555Id int identity(1,1),
    ModuleTreeId int,
    Length decimal(6,2),
    Deepth decimal(6,2),
	Height varchar(10),
...
--CMODI700TS
if exists (select * from sysobjects where name='CMODI700TS')
drop table CMODI700TS
go
create table CMODI700TS
(
    CMODI700TSId int identity(1,1),
    ModuleTreeId int,
    Length decimal(6,2),
    Deepth decimal(6,2),
	Height varchar(10),
...
if exists (select * from sysobjects where name='CMODF700TS')
drop table CMODF700TS
go
create table CMODF700TS
(
    CMODF700TSId int identity(1,1),
    ModuleTreeId int,
    Length decimal(6,2),
    Deepth decimal(6,2),
	Height varchar(10),
