...
--UVI555400
if exists (select * from sysobjects where name='pk_UVI555400Id')
    alter table UVI555400 drop constraint pk_UVI555400Id
GO
alter table UVI555400 add constraint pk_UVI555400Id primary key (UVI555400Id)
GO
if exists (select * from sysobjects where name='fk_ModuleTreeId_UVI555400')
    alter table UVI555400 drop constraint fk_ModuleTreeId_UVI555400
GO
alter table UVI555400 add constraint fk_ModuleTreeId_UVI555400 foreign key(ModuleTreeId) references ModuleTree (ModuleTreeId)
GO
if exists (select * from sysobjects where name='df_Height_UVI555400')
    alter table UVI555400 drop constraint df_Height_UVI555400
GO
alter table UVI555400 add constraint df_Height_UVI555400 default ('555') for Height
GO
...
GO
--HWUVF555400，华为1.2mm板材
if exists (select * from sysobjects where name='pk_HWUVF555400Id')
    alter table HWUVF555400 drop constraint pk_HWUVF555400Id
GO
alter table HWUVF555400 add constraint pk_HWUVF555400Id primary key (HWUVF555400Id)
GO
if exists (select * from sysobjects where name='fk_ModuleTreeId_HWUVF555400')
    alter table HWUVF555400 drop constraint fk_ModuleTreeId_HWUVF555400
GO
alter table HWUVF555400 add constraint fk_ModuleTreeId_HWUVF555400 foreign key(ModuleTreeId) references ModuleTree (ModuleTreeId)
GO
if exists (select * from sysobjects where name='df_Height_HWUVF555400')
    alter table HWUVF555400 drop constraint df_Height_HWUVF555400
GO
alter table HWUVF555400 add constraint df_Height_HWUVF555400 default ('555') for Height
GO
...
--HWUWF650，华为1.2mm板材
if exists (select * from sysobjects where name='pk_HWUWF650Id')
    alter table HWUWF650 drop constraint pk_HWUWF650Id
GO
alter table HWUWF650 add constraint pk_HWUWF650Id primary key (HWUWF650Id)
GO
if exists (select * from sysobjects where name='fk_ModuleTreeId_HWUWF650')
    alter table HWUWF650 drop constraint fk_ModuleTreeId_HWUWF650
GO
alter table HWUWF650 add constraint fk_ModuleTreeId_HWUWF650 foreign key(ModuleTreeId) references ModuleTree (ModuleTreeId)
GO
if exists (select * from sysobjects where name='df_Height_HWUWF650')
    alter table HWUWF650 drop constraint df_Height_HWUWF650
GO
alter table HWUWF650 add constraint df_Height_HWUWF650 default ('650') for Height
GO
