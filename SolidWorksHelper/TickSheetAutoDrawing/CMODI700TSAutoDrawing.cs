...
namespace SolidWorksHelper
{
    public class CMODI700TSAutoDrawing:IAutoDrawing
    {
        ...
        public void AutoDrawing(SldWorks swApp, ModuleTree tree, string projectPath)
        {
            ...
            //查询参数
            CMODI700TS item = (CMODI700TS)objCMODI700TSService.GetModelByModuleTreeId(tree.ModuleTreeId.ToString());
            ...
            {                
                ...
                #region 装配体顶层
                //烟罩深度
                swModel.ChangeDim("D1@Distance82", item.Deepth);
                //灯板加强筋
                ...
                //------------I型新风腔主体----------
                swComp = swAssy.GetComponentByNameWithSuffix(suffix, "FSHA0006-2");
                swEdit.FSHA0006(swComp, item.Length, frontPanelKaKouNo, frontPanelKaKouDis, midRoofHoleNo, midRoofSecondHoleDis, 50d, item.MARVEL, item.IRNo, item.IRDis1, item.IRDis2, item.IRDis3, "NO", "NO", item.SidePanel);
                
                //----------新风底部CJ孔板----------
                swComp = swAssy.GetComponentByNameWithSuffix(suffix, "FSHA0007-1");
                swEdit.FSHA0007(swComp, item.Length, frontCjNo, frontCjFirstDis, frontPanelHoleNo, frontPanelHoleDis, "NO", item.LEDlogo, "NO", item.SidePanel);

                //----------新风前面板----------
                swComp = swAssy.GetComponentByNameWithSuffix(suffix, "FSHA0008-1");
                swEdit.FSHA0008(swComp, item.Length, frontPanelKaKouNo, frontPanelKaKouDis, frontPanelHoleNo, frontPanelHoleDis);
