...
namespace SolidWorksHelper
{
    ...
    {
        Component2 swComp;
        readonly HWUWF650Service objHWUWF650Service = new HWUWF650Service();
        public void AutoDrawing(SldWorks swApp, ModuleTree tree, string projectPath)
        {
            ...
            */
            ...
            try
            {
                ...
                //----------MESH油网侧板----------
                swEdit.MeshFilter(swAssy, suffix, meshSideLength, item.Inlet, item.ANSUL, item.ANSide, "FNHE0162-1", "FNHE0163-1");
                #endregion
                ...
                swEdit.FNHA0109(swComp, item.Length, item.MARVEL, item.IRNo, item.IRDis1, item.IRDis2, item.IRDis3);
                //------------新风滑门导轨----------
