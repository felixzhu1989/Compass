...
{
    public class UVF555400AutoDrawing : IAutoDrawing
    {
        Component2 swComp; readonly UVF555400Service objUVF555400Service = new UVF555400Service();
        public void AutoDrawing(SldWorks swApp, ModuleTree tree, string projectPath)
        {
            ...
            //查询参数
            UVF555400 item = (UVF555400)objUVF555400Service.GetModelByModuleTreeId(tree.ModuleTreeId.ToString());
            ...
            */
            ...
            try
            {
                //----------Top Level----------
                //烟罩深度
                swModel.Parameter("D1@Distance41").SystemValue = item.Deepth / 1000d;
                ...
                //非UVHood
                //swFeat.SetSuppression2(0, 2, null); //参数1：1解压，0压缩
                if (item.UVType == "LONG") swPart.Parameter("D5@Sketch12").SystemValue = 1640d / 1000d;
                ...
                //非UVHood
                //swFeat.SetSuppression2(0, 2, null); //参数1：1解压，0压缩
                if (item.UVType == "LONG") swPart.Parameter("D4@Sketch22").SystemValue = 1500d / 1000d;
                else swPart.Parameter("D4@Sketch22").SystemValue = 790d / 1000d;
                ...
                if (item.ANSUL == "YES")
                {
                    ...
                    if ((meshSideLength - 20d / 1000d) > 57d / 1000d)
                    {
                        if (item.ANSide == "LEFT")
                        {
                            swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNHE0012-1"));
                            swComp.SetSuppression2(2); //2解压缩，0压缩
                            swPart = swComp.GetModelDoc2();
                ...
                //----------排风腔内部零件----------
                //MESH油网下导轨
                swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNHE0014-1"));
                swPart = swComp.GetModelDoc2();
                ...
                swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNHE0015-1"));
                swPart = swComp.GetModelDoc2();
                swPart.Parameter("D2@Sketch1").SystemValue = (item.Length - 5d) / 1000d;
                swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNHE0016-1"));
                swPart = swComp.GetModelDoc2();
               ...
               swFeat = swComp.FeatureByName("LPattern1");
                ...
                {
                    //LEFT
                    swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNHS0012-1"));
                    swComp.SetSuppression2(2); //2解压缩，0压缩
                    swPart = swComp.GetModelDoc2();
                    ...
                    //RIGHT
                    swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNHS0014-1"));
                    swComp.SetSuppression2(2); //2解压缩，0压缩
                    swPart = swComp.GetModelDoc2();
                    swPart.Parameter("D1@草图1").SystemValue = item.Deepth / 1000d;
                    swPart.Parameter("D1@阵列(线性)1").SystemValue = sidePanelDownCjNo;
                ...
                //----------新风滑门导轨----------
                swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNHA0010-2"));
                swPart = swComp.GetModelDoc2();
                swPart.Parameter("D2@草图1").SystemValue = (item.Length - 200d) / 1000d;
                swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNHE0010-4"));
                swPart = swComp.GetModelDoc2();
                swPart.Parameter("D1@草图1").SystemValue = (item.Length - 200d) / 1000d;
                //----------新风底部CJ孔板----------
                swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNHA0005-2"));
                swPart = swComp.GetModelDoc2();
