...
namespace SolidWorksHelper
{
    ...
    {
        readonly MU1BOXDXFService objMU1BOXDXFService = new MU1BOXDXFService();
        ...
        public void AutoDrawing(SldWorks swApp, ModuleTree tree, string projectPath)
        {
            ...
            //查询参数
            MU1BOXDXF objMU1BOXDXF = (MU1BOXDXF)objMU1BOXDXFService.GetModelByModuleTreeId(tree.ModuleTreeId.ToString());
            ...
            if (objProject.HoodType == "HoodParent")
            {
                ...
                foreach (var item in oldList)
                {
                    ...
                    {
                        ModuleTreeId = objMU1BOXDXF.ModuleTreeId,
                        PartDescription = item.PartDescription,
                        Length = item.Length,
                        Width = item.Width,
                        Thickness = item.Thickness,
                        Quantity = item.Quantity * objMU1BOXDXF.Quantity,//多个UCP
                ...
                {
                    throw new Exception("MU1BOXDXF的HoodCutlist导入数据库失败" + ex.Message);
                }
            }
            #endregion
            ...
            if (objProject.HoodType == "Ceiling")
            {
                ...
                {
                    throw new Exception("MU1BOXDXF的CeilingCutlist导入数据库失败" + ex.Message);
                }
            }
            #endregion
        }
