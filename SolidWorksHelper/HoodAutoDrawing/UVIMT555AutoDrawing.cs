    ...
    public class UVIMT555AutoDrawing : IAutoDrawing
    {
        ...
        public void AutoDrawing(SldWorks swApp, ModuleTree tree, string projectPath)
        {
            ...
            */
            ...
            decimal midRoofTopHoleDis =Convert.ToDecimal(item.Deepth/2m - 400m - 360m - 75m -(int)((item.Deepth/2 - 400m - 360m - 75m - 50m) / 50m) * 50m) / 1000m;
            //KSA数量，KSA侧板长度(以全长计算)
            ...
            try
            {
                ...
                swModel.Parameter("D1@Distance49").SystemValue = (item.Deepth - 800m) / 2000m;
                ...
                swPart = swComp.GetModelDoc2();
                swPart.Parameter("D1@草图1").SystemValue = (item.Length - 3.5m) / 1000m;
                ...
                swPart.Parameter("D2@草图1").SystemValue = ((item.Deepth - 800m - 720m) / 2m - 3m + 226m) / 1000m;
                swPart.Parameter("D1@草图6").SystemValue = ((item.Deepth - 800m - 720m) / 2m - 3m + 1m) / 1000m;
