...
{
    public class UWF555400AutoDrawing : IAutoDrawing
    {
        Component2 swComp;
        readonly UWF555400Service objUWF555400Service = new UWF555400Service();
        public void AutoDrawing(SldWorks swApp, ModuleTree tree, string projectPath)
        {
            ...
            //查询参数
            UWF555400 item = (UWF555400)objUWF555400Service.GetModelByModuleTreeId(tree.ModuleTreeId.ToString());
            ...
            */
            ...
            //UWF555400斜侧板CJ孔计算,150为排风底部长度，555-400为高度差
            ...
            try
            {
                //----------Top Level----------
                //烟罩深度
                swModel.Parameter("D1@Distance81").SystemValue = item.Deepth / 1000d;
                ...
                if (item.SidePanel == "BOTH")
                {
                    ...
                    swPart.Parameter("D4@草图1").SystemValue = 150d / 1000d;
                    ...
                    swPart.Parameter("D4@Sketch1").SystemValue = 150d / 1000d;
                    ...
                    if (item.WaterCollection == "YES")
                    {
                        ...
                        swPart.Parameter("D2@Base-Flange1").SystemValue =
                            (double)(Math.Sqrt(Math.Pow((double)item.Deepth - 365d, 2) + Math.Pow(555d - 400d, 2))) / 1000d;
                        //标准烟罩(item.Deepth - 275d) / 1000d; //水洗烟罩(item.Deepth - 368) / 1000d;
                        swPart.Parameter("D5@Sketch7").SystemValue = 25d / 1000d;
                        swPart.Parameter("D4@Sketch7").SystemValue = 28d / 1000d;
                        //UV555400,18.5d,UV450400，15d，标准烟罩13.68d,水洗烟罩19.87d / 1000d
                        swPart.Parameter("D5@Sketch10").SystemValue = 22d / 1000d;
                        ...
                        //标准烟罩(item.Deepth - 275d) / 1000d; //水洗烟罩(item.Deepth - 368) / 1000d;
                        swPart.Parameter("D5@Sketch7").SystemValue = 25d / 1000d;
                        swPart.Parameter("D6@Sketch7").SystemValue = 28d / 1000d;
                        //UV555400,18.5d,UV450400，15d，标准烟罩13.68d,水洗烟罩19.87d / 1000d
                        swPart.Parameter("D5@Sketch8").SystemValue = 22d / 1000d;
                        //UV555400，22d,标准烟罩27.3
                    }
                    else
                    {
                ...
                //----------蜂窝板压条----------
                swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNHA0029-3"));
                swPart = swComp.GetModelDoc2();
                ...
                //----------新风滑门导轨----------
                swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNHA0010-3"));
                swPart = swComp.GetModelDoc2();
                ...
                //----------新风底部CJ孔板----------
                swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNHA0005-3"));
                swPart = swComp.GetModelDoc2();
