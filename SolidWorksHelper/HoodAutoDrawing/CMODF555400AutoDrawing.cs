        ...
        public void AutoDrawing(SldWorks swApp, ModuleTree tree, string projectPath)
        {
            ...
            */
            ...
            try
            {
                //----------Top Level----------
                //烟罩深度
                swModel.Parameter("D1@Distance80").SystemValue = item.Deepth / 1000d;
                ...
                if (item.SidePanel == "BOTH")
                {
                    ...
                    swComp.SetSuppression2(2); //2解压缩，0压缩
                    swEdit.FNHS0052(swComp, item.Deepth, 555d, 400d);

                    //RIGHT
                    swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNHS0053-1"));
                    swComp.SetSuppression2(2); //2解压缩，0压缩
                    swEdit.FNHS0053(swComp, item.Deepth, 555d, 400d, sidePanelSideCjNo, sidePanelDownCjNo);
