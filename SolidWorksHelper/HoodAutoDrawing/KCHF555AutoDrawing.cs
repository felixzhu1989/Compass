...
namespace SolidWorksHelper
{
    public class KCHF555AutoDrawing : IAutoDrawing
    {
        ...
        public void AutoDrawing(SldWorks swApp, ModuleTree tree, string projectPath)
        {
            ...
            //查询参数
            KCHF555 item = (KCHF555)objKCHF555Service.GetModelByModuleTreeId(tree.ModuleTreeId.ToString());
            ...
            */
            ...
            try
            {
                //----------Top Level----------
                //烟罩深度
                swModel.Parameter("D1@Distance29").SystemValue = item.Deepth / 1000d;
                ...
                if (item.ExNo == 1)
                {
                    swModel.Parameter("D1@Distance33").SystemValue = (item.ExRightDis - item.ExLength / 2) / 1000d;
                ...
                //------------F型新风腔主体----------
                swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNHA0083-1"));
                swEdit.FNHA0083(swComp, item.Length, frontPanelKaKouNo, frontPanelKaKouDis, midRoofSecondHoleDis, midRoofTopHoleDis, midRoofHoleNo, item.SuDis, item.SuNo, item.MARVEL, item.IRNo, item.IRDis1, item.IRDis2, item.IRDis3, item.SidePanel, "KV", "NO");
                ...
                //----------新风底部CJ孔板----------
                swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNHA0082-1"));
                swPart = swComp.GetModelDoc2();
