    ...
    public class KVF555AutoDrawing : IAutoDrawing
    {
        ...
        public void AutoDrawing(SldWorks swApp, ModuleTree tree, string projectPath)
        {
            ...
            try
            {
                ...
                swHoodPart.FNHA0004(swComp, item.Length, frontPanelKaKouNo, frontPanelKaKouDis, midRoofSecondHoleDis, midRoofTopHoleDis, midRoofHoleNo, item.SuDis, item.SuNo, item.MARVEL,  item.SidePanel, "KV", "NO");
                ...
                swHoodPart.FNHA0005(swComp, item.Length, frontCjNo, frontCjFirstDis, frontPanelHoleNo,
                    frontPanelHoleDis, "NO", item.LEDlogo, item.WaterCollection, item.SidePanel);
