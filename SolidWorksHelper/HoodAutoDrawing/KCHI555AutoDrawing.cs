        ...
        public void AutoDrawing(SldWorks swApp, ModuleTree tree, string projectPath)
        {
            ...
            */
            ...
            try
            {
                ...
                //KSA距离左边缘
                if (ksaSideLength < 12m / 1000m) swModel.Parameter("D1@Distance13").SystemValue = 0.5m / 1000m;
                ...
                else
                {
                    ...
                    swFeat = swComp.FeatureByName("EXCOTWO");
                    swFeat.SetSuppression2(1, 2, configNames); //参数1：1解压，0压缩
                    swPart.Parameter("D2@Sketch10").SystemValue = item.ExRightDis / 1000m;
                    swPart.Parameter("D5@Sketch10").SystemValue = item.ExDis / 1000m;
                ...
                if (item.Outlet == "LEFTTAP")
                {
                    ...
                    swFeat.SetSuppression2(1, 2, configNames); //参数1：1解压，0压缩
                    swPart.Parameter("D1@Sketch7").SystemValue = 12m / 1000m;
                ...
                else if (item.Outlet == "RIGHTTAP")
                {
                    ...
                    swFeat = swComp.FeatureByName("DRAINTAP-RIGHT");
                    swFeat.SetSuppression2(1, 2, configNames); //参数1：1解压，0压缩
                    swPart.Parameter("D2@Sketch15").SystemValue = 12m / 1000m;
                }
                else if (item.Outlet == "LEFTPIPE")//放水阀
                {
                    swFeat = swComp.FeatureByName("DRAINTAP-LEFT");
                    swFeat.SetSuppression2(1, 2, configNames); //参数1：1解压，0压缩
                    swPart.Parameter("D1@Sketch7").SystemValue = 17m / 1000m;
                    swFeat = swComp.FeatureByName("DRAINTAP-RIGHT");
                    swFeat.SetSuppression2(0, 2, configNames); //参数1：1解压，0压缩
                }
                else if (item.Outlet == "RIGHTPIPE")
                {
                    ...
                    swFeat = swComp.FeatureByName("DRAINTAP-RIGHT");
                    swFeat.SetSuppression2(1, 2, configNames); //参数1：1解压，0压缩
                    swPart.Parameter("D2@Sketch15").SystemValue = 17m / 1000m;
                }
                else
                {
                    swFeat = swComp.FeatureByName("DRAINTAP-LEFT");
                ...
                if (item.LightType == "LED60")
                {
                    ...
                    {
                        swPart.Parameter("D1@Sketch39").SystemValue = (item.LEDSpotDis * (item.LEDSpotNo / 2m - 1) + item.LEDSpotDis / 2m) / 1000m;
                ...
                else if (item.LightType == "LED140")
                {
                    ...
                    {
                        swPart.Parameter("D1@Sketch40").SystemValue = (item.LEDSpotDis * (item.LEDSpotNo / 2m - 1) + item.LEDSpotDis / 2m) / 1000m;
                        swFeat = swComp.FeatureByName("LPattern3");
                        swFeat.SetSuppression2(1, 2, configNames); //参数1：1解压，0压缩 
                ...
                else if (item.LightType == "LEDUL")
                {
                    ...
                    {
                        swPart.Parameter("D3@Sketch30").SystemValue = (item.LEDSpotDis * (item.LEDSpotNo / 2m - 1) + item.LEDSpotDis / 2m) / 1000m;
                        swFeat = swComp.FeatureByName("LPattern4");
                        swFeat.SetSuppression2(1, 2, configNames); //参数1：1解压，0压缩 
                        swPart.Parameter("D1@LPattern4").SystemValue = item.LEDSpotNo;
                        swPart.Parameter("D3@LPattern4").SystemValue = item.LEDSpotDis / 1000m;
                    }
                }
                ...
                if (item.SidePanel == "LEFT" || item.SidePanel == "BOTH")
                {
                    swComp.SetSuppression2(2); //2解压缩，0压缩;
                    swPart = swComp.GetModelDoc2();
                    swPart.Parameter("D5@Sketch1").SystemValue = (item.Deepth - 360m - 482m) / 1000m;
                }
                ...
                swPart = swComp.GetModelDoc2();
                swPart.Parameter("D4@Sketch1").SystemValue = (item.Deepth - 30m) / 1000m;
                swPart.Parameter("D6@Sketch1").SystemValue = (item.Deepth - 360m - 482m) / 1000m;
                ...
                if (item.SidePanel == "BOTH")
                {
                    ...
                    swComp.SetSuppression2(2); //2解压缩，0压缩
                    swPart = swComp.GetModelDoc2();
                    swPart.Parameter("D2@Base-Flange1").SystemValue = (item.Deepth - 258m) / 1000m;//水洗烟罩(item.Deepth - 368) / 1000m;
