...
{
    public class LLEDSAutoDrawing:IAutoDrawing
    {
        Component2 swComp; readonly LLEDSService objLLEDSService = new LLEDSService();
        public void AutoDrawing(SldWorks swApp, ModuleTree tree, string projectPath)
        {
            ...
            */
            //-----------计算中间值，----------
            int stdPanelNo = (int)((item.Length - 300.5d) / 1500d);//1500+300直接做成一块
            double sideLength = item.Length - stdPanelNo * 1500d;
            int ledNo = (int) ((sideLength - 300d) / 500d);
