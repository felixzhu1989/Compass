            ...
            */
            ...
            try
            {
                ...
                if (item.Length < 1000m)
                {
                    ...
                    swSubModel.Parameter("D3@LocalLPattern2").SystemValue = (item.Length - 400m) / 1000m;
                }
                else if (item.Length >= 1000m && item.Length < 2000m)
                {
                    swSubModel.Parameter("D1@LocalLPattern2").SystemValue = 3;
                    swSubModel.Parameter("D3@LocalLPattern2").SystemValue = (item.Length - 400m) / 2000m;
                }
                else
                {
                    swSubModel.Parameter("D1@LocalLPattern2").SystemValue = 4;
                    swSubModel.Parameter("D3@LocalLPattern2").SystemValue = (item.Length - 400m) / 3000m;
                }
                //----------侧板----------
                switch (item.SidePanel)
                {
