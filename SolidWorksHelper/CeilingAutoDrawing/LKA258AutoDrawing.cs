...
namespace SolidWorksHelper
{
    ...
    {
        Component2 swComp; readonly LKA258Service objLKA258Service = new LKA258Service();
        public void AutoDrawing(SldWorks swApp, ModuleTree tree, string projectPath)
        {
            ...
            //查询参数
            LKA258 item = (LKA258)objLKA258Service.GetModelByModuleTreeId(tree.ModuleTreeId.ToString());
            ...
            */
            ...
            try
            {
                ...
                //----------灯腔主体----------
                //重命名装配体内部
                compReName = "FNCL0001[LKA258-" + tree.Module + "]{" + (int)item.Length + "}";
                status = swModelDocExt.SelectByID2(CommonFunc.AddSuffix(suffix, "FNCL0001-1") + "@" + assyName, "COMPONENT", 0, 0, 0, false, 0, null, 0);
                ...
                //----------Y型材----------
                swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "2200600018-2"));
                swPart = swComp.GetModelDoc2();//打开零件
                swPart.Parameter("D1@Boss-Extrude1").SystemValue = item.Length / 1000d;
