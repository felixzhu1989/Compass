...
{
    public class CJ330AutoDrawing : IAutoDrawing
    {
        Component2 swComp;
        readonly CJ330Service objCJ330Service = new CJ330Service();
        public void AutoDrawing(SldWorks swApp, ModuleTree tree, string projectPath)
        {
            ...
            //查询参数
            CJ330 item = (CJ330)objCJ330Service.GetModelByModuleTreeId(tree.ModuleTreeId.ToString());
            ...
            */
            ...
            try
            {
                ...
                {
                    case "LEFT":
                        swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNCJ0025-5"));
                        swComp.SetSuppression2(2); //2解压缩，0压缩.
                        swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNCJ0027-3"));
                        swComp.SetSuppression2(2); //2解压缩，0压缩.
                        swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNCJ0026-1"));
                        swComp.SetSuppression2(0); //2解压缩，0压缩.
                        swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNCJ0027-4"));
                        swComp.SetSuppression2(0); //2解压缩，0压缩.
                        break;
                    case "RIGHT":
                        swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNCJ0025-5"));
                ...
                //----------CJ腔主体----------
                //重命名装配体内部
                compReName = "FNCJ0023[CJ330-" + tree.Module + "]{" + (int)item.Length + "}";
                status = swModelDocExt.SelectByID2(CommonFunc.AddSuffix(suffix, "FNCJ0023-2") + "@" + assyName, "COMPONENT", 0, 0, 0, false, 0, null, 0);
                ...
                swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNCJ0024-1"));
                swPart = swComp.GetModelDoc2();//打开零件
