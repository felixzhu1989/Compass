...
namespace SolidWorksHelper
{
    ...
    {
        Component2 swComp; 
        readonly KCWSB535Service objKCWSB535Service = new KCWSB535Service();
        public void AutoDrawing(SldWorks swApp, ModuleTree tree, string projectPath)
        {
            ...
            //查询参数
            KCWSB535 item = (KCWSB535)objKCWSB535Service.GetModelByModuleTreeId(tree.ModuleTreeId.ToString());
            ...
            */
            ...
            try
            {
                ...
                //防水棉
                swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNCO0004[WPSSB535]-2"));
                ...
                swModel.Parameter("D1@Distance71").SystemValue = (item.FCSideLeft + 500d * item.FCBlindNo) / 1000d;
                #endregion
                ...
                if (item.LightType == "HCL")
                {
                    ...
                    switch (item.HCLSide)
                    {
                        case "LEFT":
                            ...
                            swModel.Parameter("D1@Distance77").SystemValue = item.HCLSideLeft / 1000d;
                            break;
                        case "RIGHT":
                            swPart.Parameter("D1@Skizze1").SystemValue = (item.Length - item.HCLSideRight) / 1000d;
                            swModel.Parameter("D1@Distance77").SystemValue = 0d;
                            break;
                        case "BOTH":
                ...
                { //----------HCL侧板----------
                    ...
                    {
                        case "LEFT":
                            swModel.Parameter("D1@Distance80").SystemValue = item.HCLSideLeft/1000d;
                            //重命名装配体内部
                            ...
                            break;
                        case "RIGHT":
                            swModel.Parameter("D1@Distance80").SystemValue = 0.5d/1000d;
                            swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNCE0082-1"));
                            swComp.SetSuppression2(0); //2解压缩，0压缩.
                            //重命名装配体内部
