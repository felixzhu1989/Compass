...
{
    public class LFUSAAutoDrawing : IAutoDrawing
    {
        Component2 swComp; readonly LFUSAService objLFUSAService = new LFUSAService();
            ...
            */
            ...
            try
            {
                ...
                if (status)
                {
                    ...
                    swPart.Parameter("D1@Sketch1").SystemValue = (item.Width - 2d) / 1000d;
                    swPart.Parameter("D2@Sketch2").SystemValue = item.SuDia / 1000d;
                ...
                switch (item.SidePanel)
                {
                    case "LEFT":
                        ...
                        swComp.SetSuppression2(2); //2解压缩，0压缩.
                        swPart = swComp.GetModelDoc2();//打开零件
                        swPart.Parameter("D9@Skizze1").SystemValue = (item.Width - 2d) / 1000d;
