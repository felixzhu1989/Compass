...
{
    public class LFUPAutoDrawing : IAutoDrawing
    {
        Component2 swComp; readonly LFUPService objLFUPService = new LFUPService();
        public void AutoDrawing(SldWorks swApp, ModuleTree tree, string projectPath)
        {
            ...
            //查询参数
            LFUP item = (LFUP)objLFUPService.GetModelByModuleTreeId(tree.ModuleTreeId.ToString());
            ...
            */
            ...
            try
            {
                ...
                {
                    swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNCA0004[LFUP-1000]{1000}()-3"));
