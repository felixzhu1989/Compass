...
{
    public  class SSPTSDAutoDrawing : IAutoDrawing
    {
        Component2 swComp; readonly SSPTSDService objSSPTSDService = new SSPTSDService();
        public void AutoDrawing(SldWorks swApp, ModuleTree tree, string projectPath)
        {
            ...
            */
            ...
            try
            {
                ...
                {
                    //重命名装配体内部
                    compReName = "FNCM0013[SSPDZ-" + tree.Module + ".L]{" + (int)(item.Length - 10d) + "}(" + (int)item.LeftLength + ")";
                    ...
                    if (status)
                    {
                        ...
                        swPart.Parameter("D2@Skizze1").SystemValue = (item.Length -540d) / 1000d;
                    ...
                    //重命名装配体内部
                    compReName = "FNCM0011[SSPDW-" + tree.Module + ".L]{" + (int)(item.Length - 10d) + "}(500)";
                ...
                else
                {
                    ...
                    //重命名装配体内部
                    compReName = "FNCM0011[SSPDW-" + tree.Module + ".L]{" + (int)(item.Length - 10d) + "}(" + (int)item.LeftLength + ")";
                    status = swModelDocExt.SelectByID2(CommonFunc.AddSuffix(suffix, "FNCM0011-L[SSPDW-]{}()-4") + "@" + assyName, "COMPONENT", 0, 0, 0, false, 0, null, 0);
                    if (status) swModelDocExt.RenameDocument(compReName);
                    swModel.ClearSelection2(true);
                    status = swModelDocExt.SelectByID2(compReName + "-4" + "@" + assyName, "COMPONENT", 0, 0, 0, false, 0, null, 0);
                ...
                {
                    //重命名装配体内部
                    compReName = "FNCM0013[SSPDZ-" + tree.Module + ".R]{" + (int)(item.Length - 10d) + "}(" + (int)item.RightLength + ")";
                    ...
                    //重命名装配体内部
                    compReName = "FNCM0011[SSPDW-" + tree.Module + ".R]{" + (int)(item.Length - 10d) + "}(500)";
                ...
                else
                {
                    ...
                    swComp.SetSuppression2(0); //2解压缩，0压缩.
                    //重命名装配体内部
                    compReName = "FNCM0011[SSPDW-" + tree.Module + ".R]{" + (int)(item.Length - 10d) + "}(" + (int)item.RightLength + ")";
                    status = swModelDocExt.SelectByID2(CommonFunc.AddSuffix(suffix, "FNCM0011-R[SSPDW-]{}()-5") + "@" + assyName, "COMPONENT", 0, 0, 0, false, 0, null, 0);
                    if (status) swModelDocExt.RenameDocument(compReName);
                    swModel.ClearSelection2(true);
                    status = swModelDocExt.SelectByID2(compReName + "-5" + "@" + assyName, "COMPONENT", 0, 0, 0, false, 0, null, 0);
                ...
                //----------标准M板----------
                //重命名装配体内部
                compReName = "FNCM0012[SSPDM-" + tree.Module + "]{" + (int)(item.Length - 10d) + "}(500)";
                ...
                {
                    //重命名装配体内部
                    compReName = "FNCM0011[SSPDW-" + tree.Module + "]{" + (int)(item.Length - 10d) + "}(500)";
