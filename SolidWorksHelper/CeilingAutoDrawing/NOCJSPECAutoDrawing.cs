...
namespace SolidWorksHelper
{
    ...
    {
        Component2 swComp; readonly NOCJSPECService objNOCJSPECService = new NOCJSPECService();
            ...
            try
            {
                ...
                switch (item.SidePanel)
                {
                    case "LEFT":
                        ...
                        swPart.Parameter("D2@Skizze1").SystemValue = (item.Height - 3d) / 1000d;
                        swPart.Parameter("D1@Sketch1").SystemValue = (item.BackBend - 2.5d) / 1000d;
                        ...
                        swPart.Parameter("D1@Skizze1").SystemValue = (item.Width - 2d) / 1000d;
                        swPart.Parameter("D2@Skizze1").SystemValue = (item.Height - 3d) / 1000d;
                        swPart.Parameter("D1@Sketch3").SystemValue = (item.BackBend - 2.5d) / 1000d;
                    ...
                    case "NOCJBACKL":
                        ...
                        swPart.Parameter("D2@Skizze1").SystemValue = (item.Height - 3d) / 1000d;
                        swPart.Parameter("D1@Sketch1").SystemValue = (item.BackBend - 1d) / 1000d;
                        swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNCJ0030-1"));
                        swComp.SetSuppression2(0); //2解压缩，0压缩.
                        swComp = swAssy.GetComponentByName(CommonFunc.AddSuffix(suffix, "FNCJ0031-3"));
                        swComp.SetSuppression2(2); //2解压缩，0压缩.
                ...
                if (status)
                {
                    ...
                    swPart.Parameter("D1@Skizze1").SystemValue = item.Height / 1000d;
                    swPart.Parameter("D1@Skizze17").SystemValue = item.TopBend / 1000d;
                    swPart.Parameter("D7@Kante-Lasche2").SystemValue = item.BackBend / 1000d;
                    ...
                    if (item.LeftBeamType == "KCJSB265")
                    {
                        ...
                        swFeat.SetSuppression2(1, 2, null); //参数1：1解压，0压缩
                        swPart.Parameter("D19@Sketch38").SystemValue = (leftSBDis + 1d) / 1000d;
                    ...
                    if (item.RightBeamType == "KCJSB265")
                    {
                        ...
                        swFeat.SetSuppression2(1, 2, null); //参数1：1解压，0压缩
                        swPart.Parameter("D18@Sketch40").SystemValue = (rightSBDis + 1d) / 1000d;
