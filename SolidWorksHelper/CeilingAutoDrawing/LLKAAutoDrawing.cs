...
{
    public class LLKAAutoDrawing : IAutoDrawing
    {
        Component2 swComp; readonly LLKAService objLLKAService = new LLKAService();
        public void AutoDrawing(SldWorks swApp, ModuleTree tree, string projectPath)
        {
            ...
            //查询参数
            LLKA item = (LLKA)objLLKAService.GetModelByModuleTreeId(tree.ModuleTreeId.ToString());
            ...
            */
            //-----------计算中间值，----------
            double sideLength = (item.Length - 17d - item.LongGlassNo * 1175d - item.ShortGlassNo * 575d) / 2;//长玻璃1158+17，558+17
            ...
            try
            {
                ...
                //----------边缘板----------
                //重命名装配体内部
                compReName = "FNCL0024[LLKA-" + tree.Module + "]{" + (int)sideLength + "}";
                status = swModelDocExt.SelectByID2(CommonFunc.AddSuffix(suffix, "FNCL0024[LLKA-]{}-1") + "@" + assyName, "COMPONENT", 0, 0, 0, false, 0, null, 0);
                ...
                if (status)
                {
                    ...
                    swPart.Parameter("D2@Skizze1").SystemValue = sideLength / 1000d;
                }
