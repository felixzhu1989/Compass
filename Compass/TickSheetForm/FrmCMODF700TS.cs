...
namespace Compass
{
    public partial class FrmCMODF700TS : MetroFramework.Forms.MetroForm
    {
        readonly CMODF700TSService _objCMODF700TSService = new CMODF700TSService();
        private readonly CMODF700TS _objCMODF700TS = null;
        private ModelView modelView;
        public FrmCMODF700TS()
        {
            InitializeComponent();
            SetVisibleFalse();
            IniCob();
        ...
        public FrmCMODF700TS(Drawing drawing, ModuleTree tree) : this()
        {
            _objCMODF700TS = (CMODF700TS)_objCMODF700TSService.GetModelByModuleTreeId(tree.ModuleTreeId.ToString());
            if (_objCMODF700TS == null) return;
        ...
        private void IniCob()
        {
            ...
            cobANDetectorEnd.Items.Add("BOTH");
        ...
        {
            if (_objCMODF700TS == null) return;
            panel1.Tag = _objCMODF700TS.CMODF700TSId;

            cobSidePanel.Text = _objCMODF700TS.SidePanel;
            //默认ExNo为1
            cobExNo.Text = _objCMODF700TS.ExNo == 0 ? "1" : _objCMODF700TS.ExNo.ToString();
            cobSuNo.Text = _objCMODF700TS.ExNo == 0 ? "2" : _objCMODF700TS.SuNo.ToString();
            cobLightType.Text = _objCMODF700TS.LightType;
            cobLEDSpotNo.Text = _objCMODF700TS.LEDSpotNo.ToString();
            cobANSUL.Text = _objCMODF700TS.ANSUL;
            cobANSide.Text = _objCMODF700TS.ANSide;
            cobANDetectorEnd.Text = _objCMODF700TS.ANDetectorEnd;
            cobANDropNo.Text = _objCMODF700TS.ANDropNo.ToString();
            cobANDetectorNo.Text = _objCMODF700TS.ANDetectorNo.ToString();
            cobMARVEL.Text = _objCMODF700TS.MARVEL;
            cobIRNo.Text = _objCMODF700TS.IRNo.ToString();
            cobLEDLogo.Text = _objCMODF700TS.LEDlogo;
            cobOutlet.Text = _objCMODF700TS.Outlet;
            cobInlet.Text = _objCMODF700TS.Inlet;
            cobBackToBack.Text = _objCMODF700TS.BackToBack;

            txtLength.Text = _objCMODF700TS.Length.ToString();
            txtDeepth.Text = _objCMODF700TS.Deepth.ToString();
            txtExRightDis.Text = _objCMODF700TS.ExRightDis.ToString();
            txtExDis.Text = _objCMODF700TS.ExDis.ToString();
            txtSuDis.Text = _objCMODF700TS.SuDis.ToString();
            txtExLength.Text = _objCMODF700TS.ExLength.ToString();
            txtExWidth.Text = _objCMODF700TS.ExWidth.ToString();
            txtExHeight.Text = _objCMODF700TS.ExHeight.ToString();
            //LEDSpotDis默认400
            txtLEDSpotDis.Text = _objCMODF700TS.LEDSpotDis == 0 ? "400" : _objCMODF700TS.LEDSpotDis.ToString();
            txtANYDis.Text = _objCMODF700TS.ANYDis.ToString();
            txtANDropDis1.Text = _objCMODF700TS.ANDropDis1.ToString();
            txtANDropDis2.Text = _objCMODF700TS.ANDropDis2.ToString();
            txtANDropDis3.Text = _objCMODF700TS.ANDropDis3.ToString();
            txtANDropDis4.Text = _objCMODF700TS.ANDropDis4.ToString();
            txtANDropDis5.Text = _objCMODF700TS.ANDropDis5.ToString();
            txtANDetectorDis1.Text = _objCMODF700TS.ANDetectorDis1.ToString();
            txtANDetectorDis2.Text = _objCMODF700TS.ANDetectorDis2.ToString();
            txtANDetectorDis3.Text = _objCMODF700TS.ANDetectorDis3.ToString();
            txtANDetectorDis4.Text = _objCMODF700TS.ANDetectorDis4.ToString();
            txtANDetectorDis5.Text = _objCMODF700TS.ANDetectorDis5.ToString();
            txtIRDis1.Text = _objCMODF700TS.IRDis1.ToString();
            txtIRDis2.Text = _objCMODF700TS.IRDis2.ToString();
            txtIRDis3.Text = _objCMODF700TS.IRDis3.ToString();
        }
        /// <summary>
        /// 修改参数
        /// </summary>
        ...
        private void btnEditData_Click(object sender, EventArgs e)
        {
            ...
            #endregion
            //封装对象
            CMODF700TS objCMODF700TS = new CMODF700TS()
            {
                CMODF700TSId = Convert.ToInt32(panel1.Tag),
            ...
            try
            {
                if (_objCMODF700TSService.EditModel(objCMODF700TS) == 1)
                {
