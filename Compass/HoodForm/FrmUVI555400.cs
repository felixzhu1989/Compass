...
namespace Compass
{
    public partial class FrmUVI555400 : MetroFramework.Forms.MetroForm
    {
        readonly UVI555400Service _objUVI555400Service = new UVI555400Service();
        private readonly UVI555400 _objUVI555400;
        ...
        public FrmUVI555400(Drawing drawing, ModuleTree tree) : this()
        {
            _objUVI555400 = (UVI555400)_objUVI555400Service.GetModelByModuleTreeId(tree.ModuleTreeId.ToString());
            if (_objUVI555400 == null) return;
        ...
        {
            if (_objUVI555400 == null) return;
            panel1.Tag = _objUVI555400.UVI555400Id;

            cobSidePanel.Text = _objUVI555400.SidePanel;
            //默认ExNo为1
            cobExNo.Text = _objUVI555400.ExNo == 0 ? "1" : _objUVI555400.ExNo.ToString();
            cobLightType.Text = _objUVI555400.LightType;
            cobLEDSpotNo.Text = _objUVI555400.LEDSpotNo.ToString();
            cobANSUL.Text = _objUVI555400.ANSUL;
            cobANSide.Text = _objUVI555400.ANSide;
            cobANDetector.Text = _objUVI555400.ANDetector;
            cobANDropNo.Text = _objUVI555400.ANDropNo.ToString();
            cobMARVEL.Text = _objUVI555400.MARVEL;
            cobIRNo.Text = _objUVI555400.IRNo.ToString();
            cobUVType.Text = _objUVI555400.UVType;
            cobBluetooth.Text = _objUVI555400.Bluetooth;
            cobLEDLogo.Text = _objUVI555400.LEDlogo;
            cobOutlet.Text = _objUVI555400.Outlet;
            cobWaterCollection.Text = _objUVI555400.WaterCollection;
            cobBackToBack.Text = _objUVI555400.BackToBack;

            txtLength.Text = _objUVI555400.Length.ToString();
            txtDeepth.Text = _objUVI555400.Deepth.ToString();
            txtExRightDis.Text = _objUVI555400.ExRightDis.ToString();
            txtExDis.Text = _objUVI555400.ExDis.ToString();
            txtExLength.Text = _objUVI555400.ExLength.ToString();
            txtExWidth.Text = _objUVI555400.ExWidth.ToString();
            txtExHeight.Text = _objUVI555400.ExHeight.ToString();
            //LEDSpotDis默认400
            txtLEDSpotDis.Text = _objUVI555400.LEDSpotDis == 0 ? "400" : _objUVI555400.LEDSpotDis.ToString();
            txtANYDis.Text = _objUVI555400.ANYDis.ToString();
            txtDropDis1.Text = _objUVI555400.ANDropDis1.ToString();
            txtDropDis2.Text = _objUVI555400.ANDropDis2.ToString();
            txtDropDis3.Text = _objUVI555400.ANDropDis3.ToString();
            txtDropDis4.Text = _objUVI555400.ANDropDis4.ToString();
            txtDropDis5.Text = _objUVI555400.ANDropDis5.ToString();
            txtIRDis1.Text = _objUVI555400.IRDis1.ToString();
            txtIRDis2.Text = _objUVI555400.IRDis2.ToString();
            txtIRDis3.Text = _objUVI555400.IRDis3.ToString();
        }
        /// <summary>
        /// 修改参数
        /// </summary>
        ...
        private void btnEditData_Click(object sender, EventArgs e)
        {
            ...
            #endregion
            //封装对象
            UVI555400 objUVI555400 = new UVI555400()
            {
                UVI555400Id = Convert.ToInt32(panel1.Tag),
            ...
            try
            {
                if (_objUVI555400Service.EditModel(objUVI555400) == 1)
                {
