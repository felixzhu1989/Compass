...
namespace Compass
{
    public partial class FrmHWUVF555400 : MetroFramework.Forms.MetroForm
    {
        readonly HWUVF555400Service _objHWUVF555400Service = new HWUVF555400Service();
        private readonly HWUVF555400 _objHWUVF555400 = null;
        private ModelView modelView;
        public FrmHWUVF555400()
        {
            InitializeComponent();
        ...
        public FrmHWUVF555400(Drawing drawing, ModuleTree tree) : this()
        {
            _objHWUVF555400 = (HWUVF555400)_objHWUVF555400Service.GetModelByModuleTreeId(tree.ModuleTreeId.ToString());
            if (_objHWUVF555400 == null) return;
        ...
        {
            if (_objHWUVF555400 == null) return;
            modelView.Tag = _objHWUVF555400.HWUVF555400Id;

            cobSidePanel.Text = _objHWUVF555400.SidePanel;
            //默认ExNo为1
            cobExNo.Text = _objHWUVF555400.ExNo == 0 ? "1" : _objHWUVF555400.ExNo.ToString();
            cobSuNo.Text = _objHWUVF555400.ExNo == 0 ? "2" : _objHWUVF555400.SuNo.ToString();
            cobLightType.Text = _objHWUVF555400.LightType;
            cobLEDSpotNo.Text = _objHWUVF555400.LEDSpotNo.ToString();
            cobANSUL.Text = _objHWUVF555400.ANSUL;
            cobANSide.Text = _objHWUVF555400.ANSide;
            cobANDetector.Text = _objHWUVF555400.ANDetector;
            cobANDropNo.Text = _objHWUVF555400.ANDropNo.ToString();
            cobMARVEL.Text = _objHWUVF555400.MARVEL;
            cobIRNo.Text = _objHWUVF555400.IRNo.ToString();
            cobUVType.Text = _objHWUVF555400.UVType;
            cobBluetooth.Text = _objHWUVF555400.Bluetooth;
            cobLEDLogo.Text = _objHWUVF555400.LEDlogo;
            cobOutlet.Text = _objHWUVF555400.Outlet;
            cobWaterCollection.Text = _objHWUVF555400.WaterCollection;
            cobBackToBack.Text = _objHWUVF555400.BackToBack;

            txtLength.Text = _objHWUVF555400.Length.ToString();
            txtDeepth.Text = _objHWUVF555400.Deepth.ToString();
            txtExRightDis.Text = _objHWUVF555400.ExRightDis.ToString();
            txtExDis.Text = _objHWUVF555400.ExDis.ToString();
            txtSuDis.Text = _objHWUVF555400.SuDis.ToString();
            txtExLength.Text = _objHWUVF555400.ExLength.ToString();
            txtExWidth.Text = _objHWUVF555400.ExWidth.ToString();
            txtExHeight.Text = _objHWUVF555400.ExHeight.ToString();
            txtLightYDis.Text = _objHWUVF555400.LightYDis.ToString();
            //LEDSpotDis默认400
            txtLEDSpotDis.Text = _objHWUVF555400.LEDSpotDis == 0 ? "400" : _objHWUVF555400.LEDSpotDis.ToString();
            txtANYDis.Text = _objHWUVF555400.ANYDis.ToString();
            txtDropDis1.Text = _objHWUVF555400.ANDropDis1.ToString();
            txtDropDis2.Text = _objHWUVF555400.ANDropDis2.ToString();
            txtDropDis3.Text = _objHWUVF555400.ANDropDis3.ToString();
            txtDropDis4.Text = _objHWUVF555400.ANDropDis4.ToString();
            txtDropDis5.Text = _objHWUVF555400.ANDropDis5.ToString();
            txtIRDis1.Text = _objHWUVF555400.IRDis1.ToString();
            txtIRDis2.Text = _objHWUVF555400.IRDis2.ToString();
            txtIRDis3.Text = _objHWUVF555400.IRDis3.ToString();
        }
        /// <summary>
        /// 修改参数
        /// </summary>
        ...
        private void BtnEditData_Click(object sender, EventArgs e)
        {
            ...
            #endregion
            //封装对象
            HWUVF555400 objHWUVF555400 = new HWUVF555400()
            {
                HWUVF555400Id = Convert.ToInt32(modelView.Tag),
            ...
            try
            {
                if (_objHWUVF555400Service.EditModel(objHWUVF555400) == 1)
                {
