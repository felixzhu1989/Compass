    ...
    public partial class FrmKcjsb535 : MetroFramework.Forms.MetroForm
    {
        ...
        private void btnEditData_Click(object sender, EventArgs e)
        {
            ...
            KCJSB535 objKcjsb535 = new KCJSB535
            {
                ...
                Length = txtLength.Text.Trim().Length == 0 ? 0 : Convert.ToDouble(txtLength.Text.Trim()),
                ExRightDis = txtExRightDis.Text.Trim().Length == 0 ? 0 : Convert.ToDouble(txtExRightDis.Text.Trim()),
                ExLength = txtExLength.Text.Trim().Length == 0 ? 0 : Convert.ToDouble(txtExLength.Text.Trim()),
                ExWidth = txtExWidth.Text.Trim().Length == 0 ? 0 : Convert.ToDouble(txtExWidth.Text.Trim()),
                ExHeight = txtExHeight.Text.Trim().Length == 0 ? 0 : Convert.ToDouble(txtExHeight.Text.Trim()),
                GutterWidth = txtGutterWidth.Text.Trim().Length == 0 ? 0 : Convert.ToDouble(txtGutterWidth.Text.Trim()),
                FCSideLeft = txtFCSideLeft.Text.Trim().Length == 0 ? 0 : Convert.ToDouble(txtFCSideLeft.Text.Trim()),
                FCSideRight = txtFCSideRight.Text.Trim().Length == 0 ? 0 : Convert.ToDouble(txtFCSideRight.Text.Trim()),
