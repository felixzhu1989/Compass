...
namespace Compass
{
    public partial class FrmFRKVF555 : MetroFramework.Forms.MetroForm
    {
        readonly FRKVF555Service _objFRKVF555Service = new FRKVF555Service();
        private readonly FRKVF555 _objFRKVF555 = null;
        ...
        public FrmFRKVF555(Drawing drawing, ModuleTree tree) : this()
        {
            _objFRKVF555 = (FRKVF555)_objFRKVF555Service.GetModelByModuleTreeId(tree.ModuleTreeId.ToString());
            if (_objFRKVF555 == null) return;
        ...
        {
            if (_objFRKVF555 == null) return;
            _modelView.Tag = _objFRKVF555.FRKVF555Id;

            cobSidePanel.Text = _objFRKVF555.SidePanel;
            //默认ExNo为1
            cobExNo.Text = _objFRKVF555.ExNo == 0 ? "1" : _objFRKVF555.ExNo.ToString();
            cobSuNo.Text = _objFRKVF555.ExNo == 0 ? "2" : _objFRKVF555.SuNo.ToString();
            cobLightType.Text = _objFRKVF555.LightType;
            cobLEDSpotNo.Text = _objFRKVF555.LEDSpotNo.ToString();
            cobANSUL.Text = _objFRKVF555.ANSUL;
            cobANSide.Text = _objFRKVF555.ANSide;
            cobANDetector.Text = _objFRKVF555.ANDetector;
            cobANDropNo.Text = _objFRKVF555.ANDropNo.ToString();
            cobMARVEL.Text = _objFRKVF555.MARVEL;
            cobIRNo.Text = _objFRKVF555.IRNo.ToString();
            cobLEDLogo.Text = _objFRKVF555.LEDlogo;
            cobOutlet.Text = _objFRKVF555.Outlet;
            cobWaterCollection.Text = _objFRKVF555.WaterCollection;
            cobBackToBack.Text = _objFRKVF555.BackToBack;

            txtLength.Text = _objFRKVF555.Length.ToString();
            txtDeepth.Text = _objFRKVF555.Deepth.ToString();
            txtExRightDis.Text = _objFRKVF555.ExRightDis.ToString();
            txtExDis.Text = _objFRKVF555.ExDis.ToString();
            txtSuDis.Text = _objFRKVF555.SuDis.ToString();
            txtExLength.Text = _objFRKVF555.ExLength.ToString();
            txtExWidth.Text = _objFRKVF555.ExWidth.ToString();
            txtExHeight.Text = _objFRKVF555.ExHeight.ToString();
            //LEDSpotDis默认400
            txtLEDSpotDis.Text = _objFRKVF555.LEDSpotDis == 0 ? "400" : _objFRKVF555.LEDSpotDis.ToString();
            txtANYDis.Text = _objFRKVF555.ANYDis.ToString();
            txtDropDis1.Text = _objFRKVF555.ANDropDis1.ToString();
            txtDropDis2.Text = _objFRKVF555.ANDropDis2.ToString();
            txtDropDis3.Text = _objFRKVF555.ANDropDis3.ToString();
            txtDropDis4.Text = _objFRKVF555.ANDropDis4.ToString();
            txtDropDis5.Text = _objFRKVF555.ANDropDis5.ToString();
            txtIRDis1.Text = _objFRKVF555.IRDis1.ToString();
            txtIRDis2.Text = _objFRKVF555.IRDis2.ToString();
            txtIRDis3.Text = _objFRKVF555.IRDis3.ToString();
        }
        /// <summary>
        /// 修改参数
        /// </summary>
        ...
        private void BtnEditData_Click(object sender, EventArgs e)
        {
            ...
            #endregion
            //封装对象
            FRKVF555 objFRKVF555 = new FRKVF555()
            {
                FRKVF555Id = Convert.ToInt32(_modelView.Tag),
            ...
            try
            {
                if (_objFRKVF555Service.EditModel(objFRKVF555) == 1)
                {
