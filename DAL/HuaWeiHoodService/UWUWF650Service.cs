...
namespace DAL
{
    public class HWUWF650Service : IModelService
    {
        /// <summary>
        /// 根据项目Id查询HWUWF650集合
        /// </summary>
        ...
        /// <summary>
        /// 根据HWUWF650ID返回HWUWF650
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public IModel GetModelById(string id)
        {
            return GetModelByWhereSql($" where HWUWF650Id={id}");
        }
        /// <summary>
        /// 根据模型树ID返回HWUWF650
        /// </summary>
        ...
        {
            string sql =
                "select HWUWF650Id,ModuleTreeId,Length,Deepth,ExRightDis,ExNo,EXDis,ExLength,ExWidth,ExHeight,SuNo,SuDis,SidePanel," +
                ...
                "MARVEL,IRNo,IRDis1,IRDis2,IRDis3 from HWUWF650";
            sql += whereSql;
            SqlDataReader objReader = SQLHelper.GetReader(sql);
            HWUWF650 objModel = null;
            if (objReader.Read())
            {
                objModel = new HWUWF650()
                {
                    HWUWF650Id = Convert.ToInt32(objReader["HWUWF650Id"]),
        ...
        {
            HWUWF650 objModel = (HWUWF650)model;
            //编写带参数的SQL语句
            StringBuilder sqlBuilder = new StringBuilder();
            sqlBuilder.Append("Update HWUWF650 set Length=@Length,Deepth=@Deepth,ExRightDis=@ExRightDis,ExNo=@ExNo,ExDis=@ExDis,ExLength=@ExLength,ExWidth=@ExWidth,ExHeight=@ExHeight,SuNo=@SuNo,SuDis=@SuDis,SidePanel=@SidePanel,");
            ...
            sqlBuilder.Append("MARVEL=@MARVEL,IRNo=@IRNo,IRDis1=@IRDis1,IRDis2=@IRDis2,IRDis3=@IRDis3 where HWUWF650Id=@HWUWF650Id");
            //定义参数数组
            SqlParameter[] param = new SqlParameter[]
            {
                ...
                new SqlParameter("@HWUWF650Id",objModel.HWUWF650Id)
            };
            try
            {
