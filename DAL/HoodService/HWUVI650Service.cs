...
namespace DAL
{
    public class HWUVI650Service : IModelService
    {
        /// <summary>
        /// 根据项目Id查询HWUVI650集合
        /// </summary>
        ...
        {
            string sql = "select HWUVI650Id,HWUVI650.ModuleTreeId,Item,Module,Length,Deepth,ExRightDis,ExNo,EXDis,ExLength,ExWidth,ExHeight,SidePanel,Outlet,LEDlogo,Bluetooth,BackToBack,WaterCollection,LEDSpotNo,LEDSpotDis,LightType,LightYDis,UVType,ANSUL,ANSide,ANDetector,ANYDis,ANDropNo,ANDropDis1,ANDropDis2,ANDropDis3,ANDropDis4,ANDropDis5,MARVEL,IRNo,IRDis1,IRDis2,IRDis3 from HWUVI650";
            sql += " inner join ModuleTree on HWUVI650.ModuleTreeId=ModuleTree.ModuleTreeId";
        ...
        /// <summary>
        /// 根据HWUVI650ID返回HWUVI650
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public IModel GetModelById(string id)
        {
            return GetModelByWhereSql(string.Format(" where HWUVI650Id={0}", id));
        }
        /// <summary>
        /// 根据模型树ID返回HWUVI650
        /// </summary>
        ...
        {
            string sql =
                "select HWUVI650Id,ModuleTreeId,Length,Deepth,ExRightDis,ExNo,EXDis,ExLength,ExWidth,ExHeight,SidePanel,Outlet,LEDlogo,Bluetooth,BackToBack,WaterCollection,LEDSpotNo,LEDSpotDis,LightType,LightYDis,UVType,ANSUL,ANSide,ANDetector,ANYDis,ANDropNo,ANDropDis1,ANDropDis2,ANDropDis3,ANDropDis4,ANDropDis5,MARVEL,IRNo,IRDis1,IRDis2,IRDis3 from HWUVI650";
            sql += whereSql;
            SqlDataReader objReader = SQLHelper.GetReader(sql);
            HWUVI650 objModel = null;
            if (objReader.Read())
            {
                objModel = new HWUVI650()
                {
                    HWUVI650Id = Convert.ToInt32(objReader["HWUVI650Id"]),
        ...
        {
            HWUVI650 objModel = (HWUVI650)model;
            //编写带参数的SQL语句
            StringBuilder sqlBuilder = new StringBuilder();
            sqlBuilder.Append("Update HWUVI650 set Length=@Length,Deepth=@Deepth,ExRightDis=@ExRightDis,ExNo=@ExNo,ExDis=@ExDis,ExLength=@ExLength,ExWidth=@ExWidth,ExHeight=@ExHeight,SidePanel=@SidePanel,");
            ...
            sqlBuilder.Append("MARVEL=@MARVEL,IRNo=@IRNo,IRDis1=@IRDis1,IRDis2=@IRDis2,IRDis3=@IRDis3 where HWUVI650Id=@HWUVI650Id");
            //定义参数数组
            SqlParameter[] param = new SqlParameter[]
            {
                ...
                new SqlParameter("@HWUVI650Id",objModel.HWUVI650Id)
            };
            try
            {
