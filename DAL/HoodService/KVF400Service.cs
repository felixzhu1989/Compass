...
namespace DAL
{
    public class KVF400Service : IModelService
    {
        /// <summary>
        /// 根据项目Id查询KVF400集合
        /// </summary>
        ...
        {
            string sql = "select KVF400Id,KVF400.ModuleTreeId,Item,Module,Length,Deepth,ExRightDis,ExNo,EXDis,ExLength,ExWidth,ExHeight,SuNo,SuDis,SidePanel,Outlet,LEDlogo,BackToBack,WaterCollection,LEDSpotNo,LEDSpotDis,LightType,ANSUL,ANSide,ANDetector,ANYDis,ANDropNo,ANDropDis1,ANDropDis2,ANDropDis3,ANDropDis4,ANDropDis5,MARVEL,IRNo,IRDis1,IRDis2,IRDis3 from KVF400";
            sql += " inner join ModuleTree on KVF400.ModuleTreeId=ModuleTree.ModuleTreeId";
        ...
        {
            return GetModelByWhereSql(string.Format(" where KVF400Id={0}", id));
        }
        /// <summary>
        /// 根据模型树ID返回KVF400
        /// </summary>
        ...
        {
            string sql =
                "select KVF400Id,ModuleTreeId,Length,Deepth,ExRightDis,ExNo,EXDis,ExLength,ExWidth,ExHeight,SuNo,SuDis,SidePanel," +
                ...
                "MARVEL,IRNo,IRDis1,IRDis2,IRDis3 from KVF400";
            sql += whereSql;
            SqlDataReader objReader = SQLHelper.GetReader(sql);
            KVF400 objModel = null;
            if (objReader.Read())
            {
                objModel = new KVF400()
                {
                    KVF400Id = Convert.ToInt32(objReader["KVF400Id"]),
        ...
        {
            KVF400 objModel = (KVF400)model;
            //编写带参数的SQL语句
            StringBuilder sqlBuilder = new StringBuilder();
            sqlBuilder.Append("Update KVF400 set Length=@Length,Deepth=@Deepth,ExRightDis=@ExRightDis,ExNo=@ExNo,ExDis=@ExDis,ExLength=@ExLength,ExWidth=@ExWidth,ExHeight=@ExHeight,SuNo=@SuNo,SuDis=@SuDis,SidePanel=@SidePanel,");
            ...
            sqlBuilder.Append("MARVEL=@MARVEL,IRNo=@IRNo,IRDis1=@IRDis1,IRDis2=@IRDis2,IRDis3=@IRDis3 where KVF400Id=@KVF400Id");
            //定义参数数组
            SqlParameter[] param = new SqlParameter[]
            {
                ...
                new SqlParameter("@KVF400Id",objModel.KVF400Id)
            };
            try
            {
