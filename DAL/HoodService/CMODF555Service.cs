...
namespace DAL
{
    public class CMODF555Service : IModelService
    {
        /// <summary>
        /// 根据项目Id查询CMODF555集合
        /// </summary>
        ...
        /// <summary>
        /// 根据CMODF555ID返回CMODF555
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public IModel GetModelById(string id)
        {
            return GetModelByWhereSql(string.Format(" where CMODF555Id={0}", id));
        }
        /// <summary>
        /// 根据模型树ID返回CMODF555
        /// </summary>
        ...
        {
            string sql =
                "select CMODF555Id,ModuleTreeId,Length,Deepth,ExRightDis,ExNo,EXDis,ExLength,ExWidth,ExHeight,SuNo,SuDis,SidePanel," +
                ...
                "MARVEL,IRNo,IRDis1,IRDis2,IRDis3 from CMODF555";
            sql += whereSql;
            SqlDataReader objReader = SQLHelper.GetReader(sql);
            CMODF555 objModel = null;
            if (objReader.Read())
            {
                objModel = new CMODF555()
                {
                    CMODF555Id = Convert.ToInt32(objReader["CMODF555Id"]),
        ...
        {
            CMODF555 objModel = (CMODF555)models;
            //编写带参数的SQL语句
            StringBuilder sqlBuilder = new StringBuilder();
            sqlBuilder.Append("Update CMODF555 set Length=@Length,Deepth=@Deepth,ExRightDis=@ExRightDis,ExNo=@ExNo,ExDis=@ExDis,ExLength=@ExLength,ExWidth=@ExWidth,ExHeight=@ExHeight,SuNo=@SuNo,SuDis=@SuDis,SidePanel=@SidePanel,");
            ...
            sqlBuilder.Append("MARVEL=@MARVEL,IRNo=@IRNo,IRDis1=@IRDis1,IRDis2=@IRDis2,IRDis3=@IRDis3 where CMODF555Id=@CMODF555Id");
            //定义参数数组
            SqlParameter[] param = new SqlParameter[]
            {
                ...
                new SqlParameter("@CMODF555Id",objModel.CMODF555Id)
            };
            try
            {
