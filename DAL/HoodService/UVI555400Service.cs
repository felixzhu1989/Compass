...
namespace DAL
{
    public class UVI555400Service : IModelService
    {
        ...
        {
            string sql = "select UVI555400Id,UVI555400.ModuleTreeId,Item,Module,Length,Deepth,ExRightDis,ExNo,EXDis,ExLength,ExWidth,ExHeight,SidePanel,Outlet,LEDlogo,Bluetooth,BackToBack,WaterCollection,LEDSpotNo,LEDSpotDis,LightType,UVType,ANSUL,ANSide,ANDetector,ANYDis,ANDropNo,ANDropDis1,ANDropDis2,ANDropDis3,ANDropDis4,ANDropDis5,MARVEL,IRNo,IRDis1,IRDis2,IRDis3 from UVI555400";
            sql += " inner join ModuleTree on UVI555400.ModuleTreeId=ModuleTree.ModuleTreeId";
        ...
        /// <summary>
        /// 根据UVI555400ID返回UVI555400
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public IModel GetModelById(string id)
        {
            return GetModelByWhereSql($" where UVI555400Id={id}");
        }
        /// <summary>
        /// 根据模型树ID返回UVI555400
        /// </summary>
        ...
        {
            string sql =
                "select UVI555400Id,ModuleTreeId,Length,Deepth,ExRightDis,ExNo,EXDis,ExLength,ExWidth,ExHeight,SidePanel," +
                ...
                "MARVEL,IRNo,IRDis1,IRDis2,IRDis3 from UVI555400";
            sql += whereSql;
            SqlDataReader objReader = SQLHelper.GetReader(sql);
            UVI555400 objModel = null;
            if (objReader.Read())
            {
                objModel = new UVI555400()
                {
                    UVI555400Id = Convert.ToInt32(objReader["UVI555400Id"]),
        ...
        {
            UVI555400 objModel = (UVI555400)model;
            //编写带参数的SQL语句
            StringBuilder sqlBuilder = new StringBuilder();
            sqlBuilder.Append("Update UVI555400 set Length=@Length,Deepth=@Deepth,ExRightDis=@ExRightDis,ExNo=@ExNo,ExDis=@ExDis,ExLength=@ExLength,ExWidth=@ExWidth,ExHeight=@ExHeight,SidePanel=@SidePanel,");
            ...
            sqlBuilder.Append("MARVEL=@MARVEL,IRNo=@IRNo,IRDis1=@IRDis1,IRDis2=@IRDis2,IRDis3=@IRDis3 where UVI555400Id=@UVI555400Id");
            //定义参数数组
            SqlParameter[] param = new SqlParameter[]
            {
                ...
                new SqlParameter("@UVI555400Id",objModel.UVI555400Id)
            };
            try
            {
