...
namespace DAL
{
    public class KCHF555Service : IModelService
    {
        /// <summary>
        /// 根据项目Id查询KCHF555集合
        /// </summary>
        ...
        {
            string sql = "select KCHF555Id,KCHF555.ModuleTreeId,Item,Module,Length,Deepth,ExRightDis,ExNo,EXDis,ExLength,ExWidth,ExHeight,SuNo,SuDis,SidePanel,Outlet,LEDlogo,BackToBack,LEDSpotNo,LEDSpotDis,LightType,ANSUL,ANSide,ANDetector,ANYDis,ANDropNo,ANDropDis1,ANDropDis2,ANDropDis3,ANDropDis4,ANDropDis5,MARVEL,IRNo,IRDis1,IRDis2,IRDis3 from KCHF555";
            sql += " inner join ModuleTree on KCHF555.ModuleTreeId=ModuleTree.ModuleTreeId";
        ...
        /// <summary>
        /// 根据KCHF555ID返回KCHF555
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public IModel GetModelById(string id)
        {
            return GetModelByWhereSql(string.Format(" where KCHF555Id={0}", id));
        }
        /// <summary>
        /// 根据模型树ID返回KCHF555
        /// </summary>
        ...
        {
            string sql =
                "select KCHF555Id,ModuleTreeId,Length,Deepth,ExRightDis,ExNo,EXDis,ExLength,ExWidth,ExHeight,SuNo,SuDis,SidePanel," +
                ...
                "MARVEL,IRNo,IRDis1,IRDis2,IRDis3 from KCHF555";
            sql += whereSql;
            SqlDataReader objReader = SQLHelper.GetReader(sql);
            KCHF555 objModel = null;
            if (objReader.Read())
            {
                objModel = new KCHF555()
                {
                    KCHF555Id = Convert.ToInt32(objReader["KCHF555Id"]),
        ...
        {
            KCHF555 objModel = (KCHF555)model;
            //编写带参数的SQL语句
            StringBuilder sqlBuilder = new StringBuilder();
            sqlBuilder.Append("Update KCHF555 set Length=@Length,Deepth=@Deepth,ExRightDis=@ExRightDis,ExNo=@ExNo,ExDis=@ExDis,ExLength=@ExLength,ExWidth=@ExWidth,ExHeight=@ExHeight,SuNo=@SuNo,SuDis=@SuDis,SidePanel=@SidePanel,");
            ...
            sqlBuilder.Append("MARVEL=@MARVEL,IRNo=@IRNo,IRDis1=@IRDis1,IRDis2=@IRDis2,IRDis3=@IRDis3 where KCHF555Id=@KCHF555Id");
            //定义参数数组
            SqlParameter[] param = new SqlParameter[]
            {
                ...
                new SqlParameter("@KCHF555Id",objModel.KCHF555Id)
            };
            try
            {
