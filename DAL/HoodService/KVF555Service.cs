...
namespace DAL
{
    public class KVF555Service: IModelService
    {
        /// <summary>
        /// 根据项目Id查询KVF555集合
        /// </summary>
        ...
        {
            return GetModelByWhereSql(string.Format(" where KVF555Id={0}", id));
        }
        /// <summary>
        /// 根据模型树ID返回KVF555
        /// </summary>
        ...
        public IModel GetModelByWhereSql(string whereSql)
        {
            ...
            if (objReader.Read())
            {
                objModel = new KVF555()
                {
                    KVF555Id = Convert.ToInt32(objReader["KVF555Id"]),
