...
namespace DAL
{
    public class UVF450Service : IModelService
    {
        /// <summary>
        /// 根据项目Id查询UVF450集合
        /// </summary>
        ...
        {
            string sql = "select UVF450Id,UVF450.ModuleTreeId,Item,Module,Length,Deepth,ExRightDis,ExNo,EXDis,ExLength,ExWidth,ExHeight,SuNo,SuDis,SidePanel,Outlet,LEDlogo,Bluetooth,BackToBack,WaterCollection,LEDSpotNo,LEDSpotDis,LightType,UVType,ANSUL,ANSide,ANDetector,ANYDis,ANDropNo,ANDropDis1,ANDropDis2,ANDropDis3,ANDropDis4,ANDropDis5,MARVEL,IRNo,IRDis1,IRDis2,IRDis3 from UVF450";
            sql += " inner join ModuleTree on UVF450.ModuleTreeId=ModuleTree.ModuleTreeId";
        ...
        {
            return GetModelByWhereSql(string.Format(" where UVF450Id={0}", id));
        }
        /// <summary>
        /// 根据模型树ID返回UVF450
        /// </summary>
        ...
        {
            string sql =
                "select UVF450Id,ModuleTreeId,Length,Deepth,ExRightDis,ExNo,EXDis,ExLength,ExWidth,ExHeight,SuNo,SuDis,SidePanel," +
                ...
                "MARVEL,IRNo,IRDis1,IRDis2,IRDis3 from UVF450";
            sql += whereSql;
            SqlDataReader objReader = SQLHelper.GetReader(sql);
            UVF450 objModel = null;
            if (objReader.Read())
            {
                objModel = new UVF450()
                {
                    UVF450Id = Convert.ToInt32(objReader["UVF450Id"]),
        ...
        {
            UVF450 objModel = (UVF450)model;
            //编写带参数的SQL语句
            StringBuilder sqlBuilder = new StringBuilder();
            sqlBuilder.Append("Update UVF450 set Length=@Length,Deepth=@Deepth,ExRightDis=@ExRightDis,ExNo=@ExNo,ExDis=@ExDis,ExLength=@ExLength,ExWidth=@ExWidth,ExHeight=@ExHeight,SuNo=@SuNo,SuDis=@SuDis,SidePanel=@SidePanel,");
            ...
            sqlBuilder.Append("MARVEL=@MARVEL,IRNo=@IRNo,IRDis1=@IRDis1,IRDis2=@IRDis2,IRDis3=@IRDis3 where UVF450Id=@UVF450Id");
            //定义参数数组
            SqlParameter[] param = new SqlParameter[]
            {
                ...
                new SqlParameter("@UVF450Id",objModel.UVF450Id)
            };
            try
            {
