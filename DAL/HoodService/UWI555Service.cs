...
namespace DAL
{
    public class UWI555Service : IModelService
    {
        /// <summary>
        /// 根据项目Id查询UWI555集合
        /// </summary>
        ...
        {
            return GetModelByWhereSql(string.Format(" where UWI555Id={0}", id));
        }
        /// <summary>
        /// 根据模型树ID返回UWI555
        /// </summary>
        ...
        {
            string sql =
                "select UWI555Id,ModuleTreeId,Length,Deepth,ExRightDis,ExNo,EXDis,ExLength,ExWidth,ExHeight,SidePanel," +
                ...
                "MARVEL,IRNo,IRDis1,IRDis2,IRDis3 from UWI555";
            sql += whereSql;
            SqlDataReader objReader = SQLHelper.GetReader(sql);
            UWI555 objModel = null;
            if (objReader.Read())
            {
                objModel = new UWI555()
                {
                    UWI555Id = Convert.ToInt32(objReader["UWI555Id"]),
        ...
        {
            UWI555 objModel = (UWI555) model;
             //编写带参数的SQL语句
             StringBuilder sqlBuilder = new StringBuilder();
            sqlBuilder.Append("Update UWI555 set Length=@Length,Deepth=@Deepth,ExRightDis=@ExRightDis,ExNo=@ExNo,ExDis=@ExDis,ExLength=@ExLength,ExWidth=@ExWidth,ExHeight=@ExHeight,SidePanel=@SidePanel,");
            ...
            sqlBuilder.Append("MARVEL=@MARVEL,IRNo=@IRNo,IRDis1=@IRDis1,IRDis2=@IRDis2,IRDis3=@IRDis3 where UWI555Id=@UWI555Id");
            //定义参数数组
            SqlParameter[] param = new SqlParameter[]
            {
                ...
                new SqlParameter("@UWI555Id",objModel.UWI555Id)
            };
            try
            {
