...
namespace DAL
{
    public class HWUVF650Service : IModelService
    {
        /// <summary>
        /// 根据项目Id查询HWUVF650集合
        /// </summary>
        ...
        /// <summary>
        /// 根据HWUVF650ID返回HWUVF650
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public IModel GetModelById(string id)
        {
            return GetModelByWhereSql(string.Format(" where HWUVF650Id={0}", id));
        }
        /// <summary>
        /// 根据模型树ID返回HWUVF650
        /// </summary>
        ...
        public IModel GetModelByWhereSql(string whereSql)
        {
            ...
            if (objReader.Read())
            {
                objModel = new HWUVF650()
                {
                    HWUVF650Id = Convert.ToInt32(objReader["HWUVF650Id"]),
        ...
        {
            HWUVF650 objModel = (HWUVF650)model;
            //编写带参数的SQL语句
            StringBuilder sqlBuilder = new StringBuilder();
            sqlBuilder.Append("Update HWUVF650 set Length=@Length,Deepth=@Deepth,ExRightDis=@ExRightDis,ExNo=@ExNo,ExDis=@ExDis,ExLength=@ExLength,ExWidth=@ExWidth,ExHeight=@ExHeight,SuNo=@SuNo,SuDis=@SuDis,SidePanel=@SidePanel,");
            ...
            sqlBuilder.Append("MARVEL=@MARVEL,IRNo=@IRNo,IRDis1=@IRDis1,IRDis2=@IRDis2,IRDis3=@IRDis3 where HWUVF650Id=@HWUVF650Id");
            //定义参数数组
            SqlParameter[] param = new SqlParameter[]
            {
                ...
                new SqlParameter("@HWUVF650Id",objModel.HWUVF650Id)
            };
            try
            {
