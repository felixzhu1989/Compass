...
namespace DAL
{
    public class UVF555Service:IModelService
    {
        ...
        {
            return GetModelByWhereSql(string.Format(" where UVF555Id={0}", id));
        }
        /// <summary>
        /// 根据模型树ID返回UVF555
        /// </summary>
        ...
        public IModel GetModelByWhereSql(string whereSql)
        {
            string sql =
                ...
                "MARVEL,IRNo,IRDis1,IRDis2,IRDis3 from UVF555";
            sql += whereSql;
        ...
        public int EditModel(IModel model)
        {
            ...
            sqlBuilder.Append("MARVEL=@MARVEL,IRNo=@IRNo,IRDis1=@IRDis1,IRDis2=@IRDis2,IRDis3=@IRDis3 where UVF555Id=@UVF555Id");
            //定义参数数组
