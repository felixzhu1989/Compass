...
namespace DAL
{
    public class CMODF700TSService : IModelService
    {
        /// <summary>
        /// 根据项目Id查询CMODF700TS集合
        /// </summary>
        /// <param name="projectId"></param>
        /// <returns></returns>
        public DataSet GetModelByDataSet(string projectId)
        {
            string sql = "select CMODF700TSId,CMODF700TS.ModuleTreeId,Item,Module,Length,Deepth,ExRightDis,ExNo,EXDis,ExLength,ExWidth,ExHeight,SuNo,SuDis,SidePanel,Outlet,Inlet,LEDlogo,BackToBack,LEDSpotNo,LEDSpotDis,LightType,ANSUL,ANSide,ANDetectorEnd,ANYDis,ANDropNo,ANDropDis1,ANDropDis2,ANDropDis3,ANDropDis4,ANDropDis5,ANDetectorNo,ANDetectorDis1,ANDetectorDis2,ANDetectorDis3,ANDetectorDis4,ANDetectorDis5,MARVEL,IRNo,IRDis1,IRDis2,IRDis3 from CMODF700TS";
            sql += " inner join ModuleTree on CMODF700TS.ModuleTreeId=ModuleTree.ModuleTreeId";
        ...
        /// <summary>
        /// 根据CMODF700TSID返回CMODF700TS
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public IModel GetModelById(string id)
        {
            return GetModelByWhereSql($" where CMODF700TSId={id}");
        }
        /// <summary>
        /// 根据模型树ID返回CMODF700TS
        /// </summary>
        ...
        {
            string sql =
                "select CMODF700TSId,ModuleTreeId,Length,Deepth,ExRightDis,ExNo,EXDis,ExLength,ExWidth,ExHeight,SuNo,SuDis,SidePanel," +
                ...
                "MARVEL,IRNo,IRDis1,IRDis2,IRDis3 from CMODF700TS";
            sql += whereSql;
            SqlDataReader objReader = SQLHelper.GetReader(sql);
            CMODF700TS objModel = null;
            if (objReader.Read())
            {
                objModel = new CMODF700TS()
                {
                    CMODF700TSId = Convert.ToInt32(objReader["CMODF700TSId"]),
        ...
        {
            CMODF700TS objModel = (CMODF700TS)models;
            //编写带参数的SQL语句
            StringBuilder sqlBuilder = new StringBuilder();
            sqlBuilder.Append("Update CMODF700TS set Length=@Length,Deepth=@Deepth,ExRightDis=@ExRightDis,ExNo=@ExNo,ExDis=@ExDis,ExLength=@ExLength,ExWidth=@ExWidth,ExHeight=@ExHeight,SuNo=@SuNo,SuDis=@SuDis,SidePanel=@SidePanel,");
            ...
            sqlBuilder.Append("MARVEL=@MARVEL,IRNo=@IRNo,IRDis1=@IRDis1,IRDis2=@IRDis2,IRDis3=@IRDis3 where CMODF700TSId=@CMODF700TSId");
            //定义参数数组
            SqlParameter[] param = new SqlParameter[]
            {
                ...
                new SqlParameter("@CMODF700TSId",objModel.CMODF700TSId)
            };
            try
            {
