...
namespace DAL
{
    public class FRUVF555Service : IModelService
    {
        ...
        public int EditModel(IModel model)
        {
            ...
            sqlBuilder.Append("MARVEL=@MARVEL,IRNo=@IRNo,IRDis1=@IRDis1,IRDis2=@IRDis2,IRDis3=@IRDis3 where FRUVF555Id=@FRUVF555Id");
            //定义参数数组
