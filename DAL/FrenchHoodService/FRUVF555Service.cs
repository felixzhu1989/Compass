...
namespace DAL
{
    public class FRUVF555Service : IModelService
    {
        /// <summary>
        /// 根据项目Id查询FRUVF555集合
        /// </summary>
        ...
        {
            string sql = "select FRUVF555Id,FRUVF555.ModuleTreeId,Item,Module,Length,Deepth,ExRightDis,ExNo,EXDis,ExLength,ExWidth,ExHeight,SuNo,SuDis,SidePanel,Outlet,LEDlogo,Bluetooth,BackToBack,WaterCollection,LEDSpotNo,LEDSpotDis,LightType,UVType,ANSUL,ANSide,ANDetector,ANYDis,ANDropNo,ANDropDis1,ANDropDis2,ANDropDis3,ANDropDis4,ANDropDis5,MARVEL from FRUVF555";
            sql += " inner join ModuleTree on FRUVF555.ModuleTreeId=ModuleTree.ModuleTreeId";
        ...
        /// <summary>
        /// 根据FRUVF555ID返回FRUVF555
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public IModel GetModelById(string id)
        {
            return GetModelByWhereSql($" where FRUVF555Id={id}");
        }
        /// <summary>
        /// 根据模型树ID返回FRUVF555
        /// </summary>
        ...
        {
            string sql =
                "select FRUVF555Id,ModuleTreeId,Length,Deepth,ExRightDis,ExNo,EXDis,ExLength,ExWidth,ExHeight,SuNo,SuDis,SidePanel,Outlet,LEDlogo,Bluetooth,BackToBack,WaterCollection,LEDSpotNo,LEDSpotDis,LightType,UVType,ANSUL,ANSide,ANDetector,ANYDis,ANDropNo,ANDropDis1,ANDropDis2,ANDropDis3,ANDropDis4,ANDropDis5,MARVEL from FRUVF555"+ whereSql;
            SqlDataReader objReader = SQLHelper.GetReader(sql);
            FRUVF555 objModel = null;
            if (objReader.Read())
            {
                objModel = new FRUVF555()
                {
                    FRUVF555Id = Convert.ToInt32(objReader["FRUVF555Id"]),
        ...
        {
            FRUVF555 objModel = (FRUVF555)model;
            //编写带参数的SQL语句
            StringBuilder sqlBuilder = new StringBuilder();
            sqlBuilder.Append("Update FRUVF555 set Length=@Length,Deepth=@Deepth,ExRightDis=@ExRightDis,ExNo=@ExNo,ExDis=@ExDis,ExLength=@ExLength,ExWidth=@ExWidth,ExHeight=@ExHeight,SuNo=@SuNo,SuDis=@SuDis,SidePanel=@SidePanel,");
            ...
            sqlBuilder.Append("MARVEL=@MARVEL where FRUVF555Id=@FRUVF555Id");
            //定义参数数组
            SqlParameter[] param = new SqlParameter[]
            {
                ...
                new SqlParameter("@FRUVF555Id",objModel.FRUVF555Id)
            };
            try
            {
