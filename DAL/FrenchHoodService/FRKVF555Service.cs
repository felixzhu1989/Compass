...
namespace DAL
{
    public class FRKVF555Service : IModelService
    {
        /// <summary>
        /// 根据项目Id查询FRKVF555集合
        /// </summary>
        ...
        /// <summary>
        /// 根据FRKVF555ID返回FRKVF555
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public IModel GetModelById(string id)
        {
            return GetModelByWhereSql($" where FRKVF555Id={id}");
        }
        /// <summary>
        /// 根据模型树ID返回FRKVF555
        /// </summary>
        ...
        {
            string sql =
                "select FRKVF555Id,ModuleTreeId,Length,Deepth,ExRightDis,ExNo,EXDis,ExLength,ExWidth,ExHeight,SuNo,SuDis,SidePanel," +
                ...
                "MARVEL,IRNo,IRDis1,IRDis2,IRDis3 from FRKVF555";
            sql += whereSql;
            SqlDataReader objReader = SQLHelper.GetReader(sql);
            FRKVF555 objModel = null;
            if (objReader.Read())
            {
                objModel = new FRKVF555()
                {
                    FRKVF555Id = Convert.ToInt32(objReader["FRKVF555Id"]),
        ...
        {
            FRKVF555 objModel = (FRKVF555)model;
            //编写带参数的SQL语句
            StringBuilder sqlBuilder = new StringBuilder();
            sqlBuilder.Append("Update FRKVF555 set Length=@Length,Deepth=@Deepth,ExRightDis=@ExRightDis,ExNo=@ExNo,ExDis=@ExDis,ExLength=@ExLength,ExWidth=@ExWidth,ExHeight=@ExHeight,SuNo=@SuNo,SuDis=@SuDis,SidePanel=@SidePanel,");
            ...
            sqlBuilder.Append("MARVEL=@MARVEL,IRNo=@IRNo,IRDis1=@IRDis1,IRDis2=@IRDis2,IRDis3=@IRDis3 where FRKVF555Id=@FRKVF555Id");
            //定义参数数组
            SqlParameter[] param = new SqlParameter[]
            {
                ...
                new SqlParameter("@FRKVF555Id",objModel.FRKVF555Id)
            };
            try
            {
