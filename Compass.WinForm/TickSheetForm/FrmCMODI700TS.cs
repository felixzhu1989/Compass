...
namespace Compass
{
    public partial class FrmCMODI700TS : MetroFramework.Forms.MetroForm
    {
        readonly CMODI700TSService _objCMODI700TSService = new CMODI700TSService();
        private readonly CMODI700TS _objCMODI700TS = null;
        private ModelView modelView;
        public FrmCMODI700TS()
        {
            InitializeComponent();
            SetVisibleFalse();
            IniCob();
        ...
        public FrmCMODI700TS(Drawing drawing, ModuleTree tree) : this()
        {
            _objCMODI700TS = (CMODI700TS)_objCMODI700TSService.GetModelByModuleTreeId(tree.ModuleTreeId.ToString());
            if (_objCMODI700TS == null) return;
        ...
        {
            if (_objCMODI700TS == null) return;
            panel1.Tag = _objCMODI700TS.CMODI700TSId;

            cobSidePanel.Text = _objCMODI700TS.SidePanel;
            //默认ExNo为1
            cobExNo.Text = _objCMODI700TS.ExNo == 0 ? "1" : _objCMODI700TS.ExNo.ToString();
            cobLightType.Text = _objCMODI700TS.LightType;
            cobLEDSpotNo.Text = _objCMODI700TS.LEDSpotNo.ToString();
            cobANSUL.Text = _objCMODI700TS.ANSUL;
            cobANSide.Text = _objCMODI700TS.ANSide;
            cobANDetectorEnd.Text = _objCMODI700TS.ANDetectorEnd;
            cobANDropNo.Text = _objCMODI700TS.ANDropNo.ToString();
            cobANDetectorNo.Text = _objCMODI700TS.ANDetectorNo.ToString();
            cobMARVEL.Text = _objCMODI700TS.MARVEL;
            cobIRNo.Text = _objCMODI700TS.IRNo.ToString();
            cobLEDLogo.Text = _objCMODI700TS.LEDlogo;
            cobOutlet.Text = _objCMODI700TS.Outlet;
            cobInlet.Text = _objCMODI700TS.Inlet;
            cobBackToBack.Text = _objCMODI700TS.BackToBack;

            txtLength.Text = _objCMODI700TS.Length.ToString();
            txtDeepth.Text = _objCMODI700TS.Deepth.ToString();
            txtExRightDis.Text = _objCMODI700TS.ExRightDis.ToString();
            txtExDis.Text = _objCMODI700TS.ExDis.ToString();
            txtExLength.Text = _objCMODI700TS.ExLength.ToString();
            txtExWidth.Text = _objCMODI700TS.ExWidth.ToString();
            txtExHeight.Text = _objCMODI700TS.ExHeight.ToString();
            //LEDSpotDis默认400
            txtLEDSpotDis.Text = _objCMODI700TS.LEDSpotDis == 0 ? "400" : _objCMODI700TS.LEDSpotDis.ToString();
            txtANYDis.Text = _objCMODI700TS.ANYDis.ToString();
            txtANDropDis1.Text = _objCMODI700TS.ANDropDis1.ToString();
            txtANDropDis2.Text = _objCMODI700TS.ANDropDis2.ToString();
            txtANDropDis3.Text = _objCMODI700TS.ANDropDis3.ToString();
            txtANDropDis4.Text = _objCMODI700TS.ANDropDis4.ToString();
            txtANDropDis5.Text = _objCMODI700TS.ANDropDis5.ToString();
            txtANDetectorDis1.Text = _objCMODI700TS.ANDetectorDis1.ToString();
            txtANDetectorDis2.Text = _objCMODI700TS.ANDetectorDis2.ToString();
            txtANDetectorDis3.Text = _objCMODI700TS.ANDetectorDis3.ToString();
            txtANDetectorDis4.Text = _objCMODI700TS.ANDetectorDis4.ToString();
            txtANDetectorDis5.Text = _objCMODI700TS.ANDetectorDis5.ToString();
            txtIRDis1.Text = _objCMODI700TS.IRDis1.ToString();
            txtIRDis2.Text = _objCMODI700TS.IRDis2.ToString();
            txtIRDis3.Text = _objCMODI700TS.IRDis3.ToString();
        }
        /// <summary>
        /// 修改参数
        /// </summary>
        ...
        private void btnEditData_Click(object sender, EventArgs e)
        {
            ...
            #endregion
            //封装对象
            CMODI700TS objCMODI700TS = new CMODI700TS()
            {
                CMODI700TSId = Convert.ToInt32(panel1.Tag),
            ...
            try
            {
                if (_objCMODI700TSService.EditModel(objCMODI700TS) == 1)
                {
