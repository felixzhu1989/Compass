...
using System.Data;
using System.Text;
using Compass.WinForm.cn.com.webxml.www;
...
namespace Compass
{
    public partial class FrmProjectInfo : MetroFramework.Forms.MetroForm
    {
        ...
        void RiskLevelPie(List<ChartData> chartRiskLevelDatas)
        {
        ...
        void ProjectTypePie(List<ChartData> chartProjectTypeDatas)
        {
