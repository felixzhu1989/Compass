...
namespace Compass
{
    public partial class FrmUserLogin : MetroFramework.Forms.MetroForm
    {
        ...
        public FrmUserLogin()
        {
            ...
            //从属性中获取保存的用户名和密码
            txtUserAccount.Text = WinForm.Properties.Settings.Default.UserAccount;
            txtUserPwd.Text = WinForm.Properties.Settings.Default.UserPwd;
            cobSBU.Text = WinForm.Properties.Settings.Default.SBU;
        }
        ...
        private void BtnLogin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Program.ObjCurrentUser != null)
                {
                    ...
                    {
                        WinForm.Properties.Settings.Default.UserAccount = objUser.UserAccount;
                        WinForm.Properties.Settings.Default.UserPwd = objUser.UserPwd;
                        WinForm.Properties.Settings.Default.SBU = objUser.SBU==""? "FoodService": objUser.SBU;
                        WinForm.Properties.Settings.Default.Save();
                    }
                    else
                    {
                        WinForm.Properties.Settings.Default.UserAccount = "";
                        WinForm.Properties.Settings.Default.UserPwd = "";
                        WinForm.Properties.Settings.Default.SBU = "";
                        WinForm.Properties.Settings.Default.Save();
                    }
                    //以后再封装权限信息
                    Close();
