    ...
    public class SolidWorksSetting
    {
        ...
        public async void SolidWorksHaltonSetting()
        {
            try
            {
                ...
                _swApp.SetUserPreferenceStringValue((int) swUserPreferenceStringValue_e.swFileLocationsDocumentTemplates,@"D:\halton\01 Tech Dept\01 Design Library\01 Templates");
                //Custom Property Files自定义属性D:\halton\01 Tech Dept\01 Design Library\03 Custom Property
                _swApp.SetUserPreferenceStringValue((int) swUserPreferenceStringValue_e.swFileLocationsCustomPropertyFile, @"D:\halton\01 Tech Dept\01 Design Library\03 Custom Property");
                //Design Library设计库D:\halton\01 Tech Dept
                _swApp.SetUserPreferenceStringValue((int) swUserPreferenceStringValue_e.swFileLocationsDesignLibrary, @"D:\halton\01 Tech Dept");
                ...
                //1.?
                _swApp.SetUserPreferenceToggle((int)swUserPreferenceToggle_e.swLargeAsmModeUseLargeDesignReview, false);


                //点击Options—>Assemblies—>Envelope Components:如下图所示取消勾选框内两项
                _swApp.SetUserPreferenceToggle((int)swUserPreferenceToggle_e.swLoadEnvelopeLightweight, false);
                _swApp.SetUserPreferenceToggle((int)swUserPreferenceToggle_e.swLoadEnvelopeReadOnly, false);

                //点击Options—>Performance—>Assemblies:如下图所示取消勾选框内两项
                _swApp.SetUserPreferenceToggle((int)swUserPreferenceToggle_e.swLargeAsmModeAutoLoadLightweight, false);
                _swApp.SetUserPreferenceToggle((int)swUserPreferenceToggle_e.swPerformanceAlwaysResolveSubassemblies, false);
                ...
                _swApp.SetUserPreferenceToggle((int)swUserPreferenceToggle_e.swFeatureManagerEnableRenamingComponent, true);


                //开启动态高亮显示
                //点击Options—>Display—>如下图所示勾选框中的两项
                _swApp.SetUserPreferenceToggle((int)swUserPreferenceToggle_e.swEdgesDynamicHighlight, true);
                _swApp.SetUserPreferenceToggle((int)swUserPreferenceToggle_e.swEdgesHighlightFeatureEdges, true);
                ...
                _swApp.SetUserPreferenceToggle((int)swUserPreferenceToggle_e.swAssemblyAllowComponentMoveByDragging, true);

                //反转鼠标滚轮方向
                //点击Setting—>Views—>如下图勾选Reverse mouse wheel zoom direction
                _swApp.SetUserPreferenceToggle((int)swUserPreferenceToggle_e.swViewReverseWheelZoomDirection, true);
            ...
            finally
            {
                ...
                _swApp.SendMsgToUser("SolidWorks设置已完成！");
            }
        }
    }
}
