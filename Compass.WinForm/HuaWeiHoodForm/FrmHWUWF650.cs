...
namespace Compass
{
    public partial class FrmHWUWF650 : MetroFramework.Forms.MetroForm
    {
        private ModelView modelView;
        readonly HWUWF650Service _objHWUWF650Service = new HWUWF650Service();
        private readonly HWUWF650 _objHWUWF650 = null;
        public FrmHWUWF650()
        {
            InitializeComponent();
            SetVisibleFalse();
        ...
        public FrmHWUWF650(Drawing drawing, ModuleTree tree) : this()
        {
            _objHWUWF650 = (HWUWF650)_objHWUWF650Service.GetModelByModuleTreeId(tree.ModuleTreeId.ToString());
            if (_objHWUWF650 == null) return;
        ...
        {
            if (_objHWUWF650 == null) return;
            panel1.Tag = _objHWUWF650.HWUWF650Id;

            cobSidePanel.Text = _objHWUWF650.SidePanel;
            //默认ExNo为1
            cobExNo.Text = _objHWUWF650.ExNo == 0 ? "2" : _objHWUWF650.ExNo.ToString();
            cobSuNo.Text = _objHWUWF650.ExNo == 0 ? "2" : _objHWUWF650.SuNo.ToString();
            cobLightType.Text = _objHWUWF650.LightType;
            cobLEDSpotNo.Text = _objHWUWF650.LEDSpotNo.ToString();
            cobANSUL.Text = _objHWUWF650.ANSUL;
            cobANSide.Text = _objHWUWF650.ANSide;
            cobANDetectorEnd.Text = _objHWUWF650.ANDetectorEnd;
            cobANDropNo.Text = _objHWUWF650.ANDropNo.ToString();
            cobANDetectorNo.Text = _objHWUWF650.ANDetectorNo.ToString();
            cobMARVEL.Text = _objHWUWF650.MARVEL;
            cobIRNo.Text = _objHWUWF650.IRNo.ToString();
            cobUVType.Text = _objHWUWF650.UVType;
            cobBluetooth.Text = _objHWUWF650.Bluetooth;
            cobLEDLogo.Text = _objHWUWF650.LEDlogo;
            cobOutlet.Text = _objHWUWF650.Outlet;
            cobInlet.Text = _objHWUWF650.Inlet;
            cobWaterCollection.Text = _objHWUWF650.WaterCollection;
            cobBackToBack.Text = _objHWUWF650.BackToBack;

            txtLength.Text = _objHWUWF650.Length.ToString();
            txtDeepth.Text = _objHWUWF650.Deepth.ToString();
            txtExRightDis.Text = _objHWUWF650.ExRightDis.ToString();
            txtExDis.Text = _objHWUWF650.ExDis.ToString();
            txtSuDis.Text = _objHWUWF650.SuDis.ToString();
            txtExLength.Text = _objHWUWF650.ExLength.ToString();
            txtExWidth.Text = _objHWUWF650.ExWidth.ToString();
            txtExHeight.Text = _objHWUWF650.ExHeight.ToString();
            txtLightYDis.Text = _objHWUWF650.LightYDis.ToString();
            //LEDSpotDis默认400
            txtLEDSpotDis.Text = _objHWUWF650.LEDSpotDis == 0 ? "400" : _objHWUWF650.LEDSpotDis.ToString();
            txtANYDis.Text = _objHWUWF650.ANYDis.ToString();
            txtANDropDis1.Text = _objHWUWF650.ANDropDis1.ToString();
            txtANDropDis2.Text = _objHWUWF650.ANDropDis2.ToString();
            txtANDropDis3.Text = _objHWUWF650.ANDropDis3.ToString();
            txtANDropDis4.Text = _objHWUWF650.ANDropDis4.ToString();
            txtANDropDis5.Text = _objHWUWF650.ANDropDis5.ToString();
            txtANDetectorDis1.Text = _objHWUWF650.ANDetectorDis1.ToString();
            txtANDetectorDis2.Text = _objHWUWF650.ANDetectorDis2.ToString();
            txtANDetectorDis3.Text = _objHWUWF650.ANDetectorDis3.ToString();
            txtANDetectorDis4.Text = _objHWUWF650.ANDetectorDis4.ToString();
            txtANDetectorDis5.Text = _objHWUWF650.ANDetectorDis5.ToString();
            txtIRDis1.Text = _objHWUWF650.IRDis1.ToString();
            txtIRDis2.Text = _objHWUWF650.IRDis2.ToString();
            txtIRDis3.Text = _objHWUWF650.IRDis3.ToString();
        }
        /// <summary>
        /// 修改参数
        /// </summary>
        ...
        private void BtnEditData_Click(object sender, EventArgs e)
        {
            ...
            #endregion
            //封装对象
            HWUWF650 objHWUWF650 = new HWUWF650()
            {
                HWUWF650Id = Convert.ToInt32(panel1.Tag),
            ...
            try
            {
                if (_objHWUWF650Service.EditModel(objHWUWF650) == 1)
                {
